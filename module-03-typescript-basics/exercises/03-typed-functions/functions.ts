...
function greetStudent(name: string) {
...
function formatName(firstName:string, lastName:string, title?: string) {
  if (title) {
...
function generateId(number:number, prefix: string = "Student") {
